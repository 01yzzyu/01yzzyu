...
+ 💡 I'm profoundly interested in **Computer Vision** and **Diffusion-based GenAI**(e.g. **2D/3D AIGC**, **Medical Image Analysis** and **Digital Human**). Recently, I focused on RAG based on Web-Search via multi-prompt.
